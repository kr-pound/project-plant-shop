...
class CaringDetailService {
    async createCaringDetail(caring_detail) {
        ...
        const { preset_id, watering_period, next_due, document } = caring_detail;
        debug(`CaringDetail: creating..`);
        return caringDetailDAO.createCaringDetail(preset_id, watering_period, next_due, document);
    }
    ...
    async updateCaringDetail(id, caring_detail) {
        ...
        return caringDetailDAO.updateCaringDetail(id, preset_id, watering_period, next_due, document);
    }
